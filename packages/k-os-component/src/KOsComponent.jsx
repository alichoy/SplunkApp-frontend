...
const KOsComponent = ({ name = 'User' }) => {
    ...
    const data = [
      { id: 1, name: '_audit', description: 'system', owner: 'admin', metaLabel: [], classification: '' },
      { id: 2, name: '_main', description: '_error', owner: 'user1', metaLabel: [], classification: '' },
      { id: 3, name: '_splunk', description: '_splunkLogs_', owner: 'user2', metaLabel: [], classification: '' },
      { id: 4, name: '_audit', description: '_splunkLogs_', owner: 'admin', metaLabel: [], classification: '' },
      { id: 5, name: '_introspection', description: '_splunkLogs_', owner: 'admin', metaLabel: [], classification: '' },
